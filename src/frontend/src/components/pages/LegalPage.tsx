...
export function PrivacyPolicyPage() {
  useSeo({
    ...
    description:
      "Cybin Enterprises privacy policy — how we collect, use, and protect your personal information.",
...
export function TermsOfServicePage() {
  useSeo({
    ...
    description:
      "Cybin Enterprises terms of service governing use of our website and payment consultation services.",
